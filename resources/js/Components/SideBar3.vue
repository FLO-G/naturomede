    ...
    <nav v-show="showSideBar">
        ...
        <ul>
            <li><svg
                  ...
                  </svg><a href="/dashboard">Accueil</a></li>
            <li> <svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
            ...
            <li><svg
                  ...
                  </svg><a href="/measures">Measure</a></li>
            <li><svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  ...
                  </svg><a href="/herbals">Herbal</a></li>
            <li><svg
                  xmlns="http://www.w3.org/2000/svg"
                  fill="none"
                  viewBox="0 0 24 24"
                  ...
                  </svg><a href="/clients">Client</a></li>
            <li><svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
