<template>
    <div class="relative flex min-h-screen">
        <div v-show="showSidebar" class="bg-cyan-600 text-cyan-100 w-full space-y-6 px-2 py-4 absolute inset-y-0 left-0 md:relative md:-translate-x-0 transform transition duration-200 ease-in-out" id="sidebar">
            ...
            <nav class="h-full overflow-y-auto">
                <a href="/" class="group flex items-center space-x-2 py-3 px-4 hover:bg-cyan-700 rounded hover:text-cyan-300 transition duration-200">
                    ...
                    </svg><span class="text-white group-hover:text-cyan-300">Acceuil</span>
                    </a>
                <a href="/" class="group flex items-center space-x-2 py-3 px-4 hover:bg-cyan-700 rounded  hover:text-cyan-300 transition duration-200">
                    <svg
                    xmlns="http://www.w3.org/2000/svg"
                ...
                </svg><input id="search" placeholder="recherche" class="text-black"></div>
                <a href="#" class="group flex items-center space-x-2 py-3 px-4 hover:bg-cyan-700 rounded  hover:text-cyan-300 transition duration-200">
                <svg
                xmlns="http://www.w3.org/2000/svg"
                fill="none"
